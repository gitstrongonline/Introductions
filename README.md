...
* Run this Command
  ...
  ```
* If you're running Windows, then I recommend using Git BASH that ships with [Git for Windows](https://gitforwindows.org/) 
...
For example:
```
git checkout -b gitstrongonline#11
```
...
* Write about Yourself (in any Language)
  ...
  - Favorite TV show 
  - Hobbies 
  - Anything else you want to write like 
